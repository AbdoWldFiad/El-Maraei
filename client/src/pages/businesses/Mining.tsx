...
export default function Mining() {
  ...
  const services = [
    {
      icon: Mountain,
      title: { en: 'El maraie for Mineral Extraction', ar: 'المرعي لأستخراج المعادن' },
  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        <title>{language === 'ar' ? ' المرعي لي مصنع التعدين | المرعي جروب' : 'El maraie for Mining Factory | El maraie Group'}</title>
        ...
        <meta property="og:title" content={language === 'ar' ? 'مصنع التعدين | المرعي جروب' : 'Mining Factory | El maraie Group'} />
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            {t({ en: 'El maraie for Mining Factory', ar: 'المرعي لمصانع التعدين' })}
          </h1>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              {t({ 
                en: 'El maraie Mining Factory combines advanced technology with sustainable practices to extract and process high-quality minerals. We are committed to responsible mining that benefits both industry and environment.', 
