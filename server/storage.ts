...
export class MemStorage implements IStorage {
  ...
  private seedData() {
    const sampleNews: InsertNewsArticle[] = [
      {
        titleEn: "El-Maraei Medical Center Expands Services",
        ...
        contentEn: "El-Maraei Medical Center is proud to announce the expansion of our services with the addition of three new specialized departments. The new Cardiology, Neurology, and Orthopedics departments will provide comprehensive care with state-of-the-art equipment and experienced medical professionals.\n\nThis expansion reflects our commitment to delivering excellence in healthcare and meeting the growing needs of our community. The new facilities feature advanced diagnostic equipment and comfortable patient areas designed with modern healthcare standards in mind.\n\nWe invite patients to schedule appointments at our new departments and experience the El-Maraei Group standard of care.",
      ...
      },
      {
        ...
        excerptEn: "El-Maraei Shipping Agency announces new international shipping routes to enhance global trade connectivity.",
        excerptAr: "وكالة المرعي للملاحة تعلن عن طرق شحن دولية جديدة لتعزيز الاتصال التجاري العالمي.",
        contentEn: "El-Maraei Shipping Agency is pleased to announce the establishment of new shipping routes connecting Egyptian ports with major international trade hubs. These new routes will significantly reduce transit times and provide more efficient logistics solutions for our clients.\n\nThe expansion includes regular services to European, Asian, and African ports, offering comprehensive cargo handling and customs clearance support. Our team has worked diligently to secure partnerships with leading maritime carriers to ensure reliable and cost-effective shipping solutions.\n\nThis development positions El-Maraei Group as a key player in facilitating international trade and supporting Egypt's economic growth.",
    ...
    const sampleJobs: InsertJobListing[] = [
      {
        ...
        descriptionEn: "El-Maraei Medical Center is seeking an experienced Cardiologist to join our expanding cardiology department. The ideal candidate will have extensive experience in diagnosing and treating heart conditions.",
